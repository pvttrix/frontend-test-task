...
<template>
  <h2 id="cart-totals-heading" class="text-md font-bold text-navy-blue mb-6 mt-2">Cart Totals</h2>
  <aside class="bg-magnolia rounded-lg shadow p-6 font-lato" role="region" aria-labelledby="cart-totals-heading">
    <dl class="space-y-4">
      <div class="flex justify-between items-center">
        <dt class="text-base text-navy-blue">Subtotals:</dt>
        <dd class="text-base font-light text-navy-blue" :aria-label="subtotalLabel">
          {{ formatPrice(cartStore.totals.subtotal) }}
        </dd>
      </div>

      <div class="border-t border-bright-gray pt-4" role="separator" aria-hidden="true">
        <div class="flex justify-between items-center">
          <dt class="text-base text-navy-blue">Shipping</dt>
          <dd class="text-base font-light text-navy-blue" :aria-label="shippingLabel">
            <span v-if="cartStore.totals.shipping > 0">
              {{ formatPrice(cartStore.totals.shipping) }}
            </span>
            <span v-else class="text-navy-blue font-light">—</span>
          </dd>
        </div>
      </div>
      ...
      <div class="border-t border-bright-gray pt-4" role="separator" aria-hidden="true">
        <div class="flex justify-between items-center">
          ...
          <dd class="text-base font-light text-navy-blue" :aria-label="taxLabel">
      ...
      <div class="border-t border-bright-gray pt-4" role="separator" aria-hidden="true">
        <div class="flex justify-between items-center">
          ...
          <dd class="text-base font-light text-navy-blue" :aria-label="totalLabel">
